  ...
  const faqs = [
    ...
    },
    {
      ...
      des:
        ...
        " We want to enable you to form a long-term connection with your provider so that they can provide ongoing care for your specific condition. With that in mind, The Clareo Plastic Surgery medical weight loss program is designed for patients seeking long-term care.",
    },
    {
    ...
    },
    {
      ...
      des: "If you're eligible for treatment, our medical team will issue you a prescription. You don't need an existing prescription to use the Clareo Plastic Surgery medical medical weight loss program!",
    },
    {
      title: "How much is Clareo Plastic Surgery's medical weight loss program?",
      des:
        "Clareo Plastic Surgery's medical weight loss program will create a customized prescription plan. Guided by doctors you will receive a personalized plan, medication, and support.\n" +
        "The cost is $450 for the 1st month, which includes Medical Telehealth Consultation, Prescription, 1-Month of Segmaglutide Medication, and Shipping",
    },
    {
